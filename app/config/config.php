...
'twilio' => [
    ...
    'application' => [
        ...
        'baseUri'        => 'http://arabiatanks.com/tanks_project/',
        'publicUrl'      => 'http://arabiatanks.com/tanks_project/',
        'cryptSalt'      => 'eEAfR|_&G&f,+vU]:jFr!!A&+71w1Ms9~8_4L!<@[N@DyaIP_2My|:+.u>/6m,$D',
	'roboUrl'     => 'http://penta-test.com/matgar_mainaa/uploads/'
    ],
    'mail' => [
        'fromName' => 'Arabian Tanks',
        'fromEmail' => 'store@arabiatanks.com',
        'smtp' => [
            'server' => 'cloud.ezamil.com',
            'port' => 465,
            'security' => 'SSL',
            'username' => 'store@arabiatanks.com',
            'password' => 'tanks_project',
