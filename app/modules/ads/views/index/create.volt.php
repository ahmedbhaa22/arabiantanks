...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a type="button" href="<?= $this->url->get('index') ?>" data-toggle="modal" class="btn btn-edit-my-data green-jungle btn-outline   btn-block">
    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            <div class="row">
            <form method="POST" action="<?= $this->url->get('index/store') ?>" enctype="multipart/form-data" id="adsForm">
                <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="fieldTitle" class="col-sm-2 bg-info control-label"><?php echo $translate->_("Title"); ?></label>
                            <div class="col-sm-10">
                                <input type="text" name="title" placeholder="<?php echo $translate->_("Title"); ?>" required/>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if ($settings->enable_section) { ?>
                    <div class="form-group">
                        <div class="col-md-12">
                    ...
                    <?php if ($settings->enable_is_video) { ?>
                    <div class="form-group">
                        <div class="col-md-12">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="height" placeholder="<?php echo $translate->_("Height"); ?>">
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="width" placeholder="<?php echo $translate->_("Width"); ?>">
                            </div>
                        </div>
                    </div>
                    <?php } ?>

                    <?php if ($settings->enable_start_date) { ?>
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="fieldTitle" class="col-sm-2 bg-info control-label"><?php echo $translate->_("Start Date"); ?></label>
                            <div class="col-sm-10">
                                <input type="text" class="date-picker" name="startdate" placeholder="<?php echo $translate->_("Start Date"); ?>">
                            </div>
                        </div>
                    </div>
                    <?php } ?>

                    <?php if ($settings->enable_end_date) { ?>
                    <div class="form-group">
                        <div class="col-md-12">
                            <label for="fieldTitle" class="col-sm-2 bg-info control-label"><?php echo $translate->_("End Date"); ?></label>
                            <div class="col-sm-10">
                                <input type="text" class="date-picker" name="enddate" placeholder="<?php echo $translate->_("End Date"); ?>">
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="link" placeholder="<?php echo $translate->_("Link"); ?>" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if ($settings->enable_thumbnail) { ?>
                    <div class="form-group">
                        <div class="col-md-12">
...
<script type="text/javascript">
    ...
    $("#adsForm").on('submit',function (e){
        ...
        // validate file size
        if($("input[name='img']") && $("input[name='img']")[0].files[0].size > 5242880){
            // if invalid display error
            $("#img_error").show();
            e.preventDefault();
        }

        if($("input[name='thumbnail']") && $("input[name='thumbnail']")[0].files[0].size > 5242880){
            // if invalid display error
