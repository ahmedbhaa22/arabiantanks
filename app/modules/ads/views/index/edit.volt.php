...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            <div class="row">
            <form method="POST" action="<?= $this->url->get('index/update/') . $ad->id ?>" enctype="multipart/form-data" id="adsForm">
                ...
                <div class="col-md-6 col-xs-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-10">
                                <img src="<?= $this->url->getStatic($ad->img) ?>" class="img-responsive">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            <div class="col-sm-10">
                                <img src="<?= $this->url->getStatic($ad->thumbnail) ?>" class="img-responsive">
