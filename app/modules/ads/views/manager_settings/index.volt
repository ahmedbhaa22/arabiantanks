                    ...
                    <div class="col-md-12 no-pad col-xs-12">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                                ...
                                {% if settings.enable_start_date == 1 %}
                                checked 
                                {% endif %}
                                />
                            </div>
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-9">
                                ...
                                {% if settings.enable_thumbnail == 1 %}
                                checked 
                                {% endif %}
                                />
                            </div>
