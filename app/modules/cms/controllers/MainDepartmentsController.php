...
class MainDepartmentsController extends ControllerBase {
    ...
    public function createAction(){
        ...
        $dept->Target_Layout_ID = 0;
        $dept->Target_Action_ID = 0;
        if (!$dept->save()) {
...
//        ]);
    ...
    public function deleteAction($ID){
        ...
        $dept->delete();
        $this->flashSession->success("Department was deleted successfully");
    }
