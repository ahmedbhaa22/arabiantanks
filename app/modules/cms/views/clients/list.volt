<div class="">
                ...
                <div class="portlet light clearfix">
                    ...
                    <div class="portlet-title">
                        ...
                        <div class="actions">
                            <a type="button" href="{{url('clients/add')}}" class="btn btn-edit-my-data green-jungle btn-outline  btn-block">
                    ...
                    <div class="portlet-body">
                        ...
                        <li><a href="{{url('clients/list?page=1')}}">&laquo;&laquo;</a></li>
                        <li><a href="{{url('clients/list?page='~page.before)}}">&laquo;</a></li>
                        <?php for($i = 1; $i <= $page->total_pages; $i++){ ?>
                        {% if i == page.current %}
                        <li class="active"><span>{{i}}</span></li>
                        {% else %}
                        <li><a href="{{url('clients/list?page='~i)}}">{{i}}</a></li>
                        {% endif %}
                        <?php } ?>
                        <li><a href="{{url('clients/list?page='~page.next)}}">&raquo;</a></li>
                        <li><a href="{{url('clients/list?page='~page.last)}}">&raquo;&raquo;</a></li>
                        </ul>
                        </div>
                        <div class="col-xs-12">
                            ...
                            <button id="delete_selected_clients" class="delete-btn btn btn-danger btn-md">
