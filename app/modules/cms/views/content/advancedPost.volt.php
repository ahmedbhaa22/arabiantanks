                ...
                <form name="deleteContentForm" id="deleteContentForm" method="post" action="">
                    ...
                    <table
                        ...
                        <?php foreach ($result_set as $result): ?>
                            ...
                            <td class="sorting"><img src="<?= $this->url->get('/uploads/') ?><?php echo $result['content_Img'] ?>" style="width: 50px;height: 50px;"></td>
                            ...
                            <td class="sorting"><div class="btn-group" style="position:relative">
                                    <button class="btn btn-xs dark dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> إجراء
                                        <i class="fa fa-angle-down"></i></button><ul class="dropdown-menu" role="menu"><li>
                                            <a href="<?= $this->url->get() ?>content/edit/<?php echo $result['content_id'] ?>" data-toggle="modal"><i class="icon-tag"></i> تعديل </a></li>
                                        <li><a href="<?= $this->url->get() ?>content/delete/<?php echo $result['content_id'] ?>"><i class="icon-user"></i> حذف </a></li></ul></div></td>
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
                    </table>
