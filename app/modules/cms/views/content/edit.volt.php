...
<div class="portlet light bordered">
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <select id="dynamic_select" class="form-control">
                    ...
                    <option value="<?= $this->url->get('content/edit/' . $content_id) ?>"
                            <?php if (($lang_id_checked == 0)) { ?>selected<?php } ?>>
                    ...
                    <?php foreach ($langs as $lang) { ?>
                        <option value="<?= $this->url->get('content/edit/' . $content_id) ?>?lang_id=<?= $lang->lang_id ?>"
                                <?php if (($lang_id_checked == $lang->lang_id)) { ?>selected<?php } ?>><?= $lang->LangDetails->title ?></option>
                    <?php } ?>
                </select>
            </div>
                        ...
                        <div class="col-md-12 col-xs-12 nopadding-r nopadding-l">
                            <div class="col-md-6 col-xs-12"> <!--col right-->
                                <?php if (($settings->Title == 1)) { ?>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="kv-group-title"><h2><label for="fieldTitle"><?php echo $translate->_("Title"); ?></label></h2></div>
                                            <div class="col-sm-10">
                                ...
                                <?php if (($settings->Des == 1)) { ?>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="kv-group-title"><h2><label for="fieldDes"><?php echo $translate->_("Desc"); ?></label></h2></div>
                                            <div class="col-sm-12">
								...
								<?php if (($this->session->get('auth-identity')['is_admin'] == 1)) { ?>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="kv-group-title"><h2><label for="fieldOrder"><?php echo $translate->_("Order"); ?></label></h2></div>
                                            <div class="col-sm-10">
                                ...
                                <?php if (($settings->Img == 1)) { ?>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="kv-group-title"><h2><label for="fieldImg"><?php echo $translate->_("Main Picture"); ?></label></h2></div>
                                            <div class="col-sm-8">
                            ...
                            <div class="col-md-6 col-xs-12"> <!--col left-->
                                ...
                                <?php if (($hasRel == 1)) { ?>
                                    <div class="col-md-12 col-xs-12">
                                        <div class="form-group">
                                            <div class="kv-group-title"><h2><?php echo $translate->_($related_module_title);
                                                ?></h2></div>

                                                <a href="<?= $this->url->get('content/viewRelatedContent') ?>&parent=<?= $ID ?>&child_module=<?= $moduleRelated ?>"
                                                ...
                                                <a href="<?= $this->url->get('content/new/') . $moduleRelated ?>&parent=<?= $ID ?>"
                                                   target="_blank"
                                                   class="btn btn-transparent btn-info btn-outline btn-circle btn-sm active"><i
                                                            class="fa fa-glass"
                                ...
                                <!-- Special Cases -->
                                <?php if (($Module_ID == 20195 || $Module_ID == 20196)) { ?>
                                    <div class="col-xs-12">
                                        <div class="form-group">
    ...
    $zones,
                            ...
                            <?php if (($settings->Content == 1)) { ?>
                                <div class="col-md-12 col-xs-12">
                                    <div class="form-group">
                                        <div class="kv-group-title"><h2><label for="fieldContent"><?php echo $translate->_("Content Details"); ?></label></h2></div>
                                        <div class="col-sm-12">
            ...
            <?php if (($Module_ID == 20195)) { ?>
                <div class="tab-pane" id="5">
                    <?= $this->partial('content/partials/placesMenusEdit', ['mediaMenus' => $mediaMenus]) ?>
                </div>
            <?php } ?>
            ...
            <?php if (($settings->KvInfo == 1)) { ?>
                <div class="tab-pane" id="4">
                    <div class="col-md-12 col-xs-12 nopadding-r nopadding-l">
                        <?= $this->partial('content/partials/keyvalue/edit_kv', []) ?>
