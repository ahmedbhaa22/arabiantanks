<div class="page-bar " style="position: relative">
    <ul class="page-breadcrumb">
                    ...
                    <li>
                        <a href="{{url('content/main/') ~module.ID}}">{{module['mod_title']}}</a>
                        <i class="icon-arrow-left"></i>
                    </li>
                    
                    <li>
                        <a href="{{url('content/index/') ~module.ID}}"><?php echo $translate->_("Content"); ?> </a>
                        <i class="icon-arrow-left"></i>
                    </li>
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
        <div class="caption font-dark">
            ...
            <span class="caption-subject bold uppercase"><?php echo $translate->_("Add Content"); ?>: {{module['mod_title']}}</span>
        </div>
            ...
            <div class="form-group">
                <div class="col-md-12 col-xs-12">
                    <div class="input_fields_wrap add-new">
                        ...
                        <div><input type="text" name="mediaVideos[]" class="form-control"></div>
                    </div>
                </div>
            </div>
        </div>
