...
<?php if (true): ?>
    <div class="portlet light bordered">
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                <a type="button" href="{{url('content/new/') ~Module_ID}}&parent={{parent_id}}" data-toggle="modal"
                        ...
                        <table
                            ...
                            <?php foreach ($page->items as $content): ?>
                                <tr class="gradeX">
                                    ...
                                    {% if(list_settings.Img==1)%}
                                    <td><img src="{{ url('uploads/')}}<?php echo $content->Offers->Img ?>" style="width: 50px;height: 50px;"></td>
                                    {% endif %}
                                    {% if(list_settings.Title==1)%}
                                    ...
                                    <td>
                                        <div class="btn-group" style="position:relative">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li>
                                                    <a href="{{url('content/edit/')}}<?php echo $content->Offers->ID ?>" data-toggle="modal">
                                                        <i class="icon-tag"></i> <?php echo $translate->_("Edit"); ?></a>
                                                </li>

                                                <li>
                                                    <a href="{{url('content/delete/')}}<?php echo $content->Offers->ID ?>" class="">
