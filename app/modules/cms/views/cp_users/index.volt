<div class="portlet light bordered">
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <a type="button" href="{{ url('cp_users/new/') }}" data-toggle="modal" class="btn btn-edit-my-data green-jungle btn-outline   btn-block">
...
{{ javascript_include("js/filters/cp_users.js") }}
<style>
