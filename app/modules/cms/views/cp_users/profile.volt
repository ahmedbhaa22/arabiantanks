            ...
            <div class="portlet light clearfix">
                <div class="portlet-title">
                    <div class="caption font-dark">
                        ...
                        <span class="caption-subject bold uppercase"> صفحتي الشخصية </span>
                    </div>
                    ...
                    <div class="col-lg-10 col-md-9 col-xs-12">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    <td>موبايل</td>
                                    <td>{{user.Mobile}} <span class="fa fa-phone font-green-jungle"></span></td>
                                </tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select id="region_id" name="region_id" class="bs-select form-control select-custom" >
                                    <option></option>
                                    {% for region in regions %}
                                        {% if user.data != null and user.data.region_id  == region.id %}
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select id="city_id" name="city_id" class="bs-select form-control select-custom" >
                                   {% if user.data != null %}
                                        <option selected value="{{user.data.city.id}}">{{user.data.city.getName()}}</option>
                                        {% else %}
                        ...
                        <div class="col-xs-12 col-md-4">
                            <div class="form-group">
                                ...
                                <select id="branch_id" name="branch_id" class="bs-select form-control select-custom" >
                                    {% if user.data != null %}
                                        <option selected value="{{user.data.branch.id}}">{{user.data.branch.name}}</option>
                                        {% else %}
                                        <option selected></option>
                                        {% endif %}
                                </select>
