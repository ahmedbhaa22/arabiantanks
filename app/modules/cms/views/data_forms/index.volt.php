    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            <div class="row col-sm-12" id="filter-toggle">
                <form method="POST" action="<?= $this->url->get('data_forms/search/') ?>" enctype="multipart/form-data">
            ...
            <div class="table-scrollable">
                <table class="table table-striped table-bordered table-hover table-checkable order-column dataTable no-footer" id="sample_1" role="grid" aria-describedby="sample_1_info">
                    ...
                    <?php foreach ($page->items as $content): ?>
                        ...
                        <a href="<?= $this->url->get('data_forms_response/index/') ?><?php $content->ID ?>">
                            <tr class="gradeX">
                            <td><?php echo $content->Lang->Title ?></td>

                            <td><?php echo $content->Type ?></td>
                            <td><?php echo $content->Module->Title ?></td>
                            ...
                            <td>
                                <div class="btn-group" style="position:relative">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="<?= $this->url->get('data_forms_response/index/') ?><?php echo $content->ID ?>" data-toggle="">
                                                <i class="icon-tag"></i> عرض الرسائل</a>
                                        </li>

<!--                                        <li>-->
<!--                                            <a href="<?= $this->url->get('data_forms/delete/') ?>--><?php //echo $content->ID ?><!--" class="delete-general" onclick="return confirm('هل أنت متأكد من حذف هذا القسم الرئيسي ؟');">-->
            ...
            <div class="row">
                ...
                <div class="col-md-7 col-sm-7"><div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                        <ul class="pagination" style="visibility: visible;">
                            <li><?php echo $this->tag->linkTo("data_forms/index", "First") ?></li>
                            <li><?php echo $this->tag->linkTo("data_forms/index/?page=" . $page->before, "Previous") ?></li>
                            <li><?php echo $this->tag->linkTo("data_forms/index/?page=" . $page->next, "Next") ?></li>
                            <li><?php echo $this->tag->linkTo("data_forms/index/?page=" . $page->last, "Last") ?></li>
                        </ul>
                    </div>
                </div>
            </div>
