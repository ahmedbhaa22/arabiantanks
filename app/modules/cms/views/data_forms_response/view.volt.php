                ...
                <div class="col-md-6 col-xs-12 no-pad" style="padding:0;"> <!--col right-->
                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="form-group">
                            <label for="fieldTitle" class="col-sm-2 bg-info"><?php echo $key; ?></label>
            ...
            <div  id ="replyForm" class="col-md-12 col-xs-12 nopadding-r nopadding-l">
                ...
                <div class="form-group col-md-12 col-sm-12">
                    ...
                    <div class="col-sm-10 text-center">
                        <?php echo $this->tag->textField(["EMail", "size" => 30, "class" => "form-control", "id" => "fieldEmail", "value"=>"islam87@live.com"]) ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-12">
...
<?= $this->tag->javascriptInclude('js/form_response_replay.js') ?>
