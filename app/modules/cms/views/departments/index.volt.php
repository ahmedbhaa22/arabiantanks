...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            ...
            <div class="row col-sm-12" id="filter-toggle">
                <form method="GET" action="<?= $this->url->get('departments/search/') . $main_dept ?>" enctype="multipart/form-data">
    ...
    <div id="myModal" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-dialog ">
                            ...
                            <div class="tab-pane active" id="1">
                                <div id="sample_1_wrapper">
                                    ...
                                    <div class="col-md-6 col-xs-12 no-pad">
                                        ...
                                        <div class="col-xs-12 form-group">
                                            <label for="fieldContent" class="col-sm-3 control-label"><?= $translate->_('Order') ?></label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="col-xs-12 form-group">
                                        <label for="fieldContent" class="col-sm-2 control-label"><?= $translate->_('Details') ?></label>
                                        <div class="col-sm-10">
            ...
            <?= $this->tag->javascriptInclude('js/filters/departments.js') ?>
        </div>
    </div>
