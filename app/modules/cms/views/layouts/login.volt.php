...
<html>
    <head>
        ...
        <?= $this->tag->stylesheetLink('ropo_app/css/select2.min.css') ?>
        <?= $this->tag->stylesheetLink('ropo_app/css/select2-bootstrap.min.css') ?>
    ...
    <body class=" login">
        ...
        <div class="copyright">
            ...
            <?= $this->tag->image(['ropo_app/img/logo_small.png', 'width' => '40']) ?>
        ...
        <!-- END CORE PLUGINS -->
         ...
         <!-- BEGIN PAGE LEVEL PLUGINS -->
        <?= $this->tag->javascriptInclude('ropo_app/js/jquery-validation/jquery.validate.min.js') ?>
        <?= $this->tag->javascriptInclude('ropo_app/js/jquery-validation/additional-methods.min.js') ?>
        <?= $this->tag->javascriptInclude('ropo_app/js/select2/select2.full.min.js') ?>
        <?= $this->tag->javascriptInclude('ropo_app/js/jquery.backstretch.min.js') ?>
        <?= $this->tag->javascriptInclude('ropo_app/js/loginscript.js') ?>
