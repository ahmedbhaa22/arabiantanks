...
<!--    <link rel="stylesheet" type="text/css" href="http://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">-->
    ...
    <script type="text/javascript" src="<?= $this->url->get() ?>ropo_app/js/bower_components/moment/min/moment.min.js"></script>
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        <li>
                            <a href="<?= $this->url->get('cp_users/index') ?>">
                ...
                <li class="dropdown dropdown-user">
                    <a href="<?= $this->url->get('cp_users/lang') ?>?lang=ar" class="dropdown-toggle">
                        <i class="icon-flag"></i>
                ...
                <?php if($this->session->get('auth-identity')['Lang']=="ar"): ?>
                <li class="dropdown dropdown-user">
                    <a href="<?= $this->url->get('cp_users/lang') ?>?lang=en" class="dropdown-toggle">
                        <i class="icon-flag"></i>
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                       <li>
                            <a href="<?= $this->url->get('cp_users/scheme') ?>?scheme=scheme_1" class="theme1">
                                <?php echo $translate->_("Theme 1"); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->url->get('cp_users/scheme') ?>?scheme=scheme_2" class="theme2">
                                <?php echo $translate->_("Theme 2"); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->url->get('cp_users/scheme') ?>?scheme=scheme_3" class="theme3">
                                <?php echo $translate->_("Theme 3"); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->url->get('cp_users/scheme') ?>?scheme=scheme_4" class="theme4">
                                <?php echo $translate->_("Theme 4"); ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= $this->url->get('cp_users/scheme') ?>?scheme=scheme_5" class="theme5">
                                <?php echo $translate->_("Theme 5"); ?>
                            </a>
                        </li>
<li>
                            <a href="<?= $this->url->get('cp_users/scheme') ?>?scheme=scheme_6" class="theme6">
