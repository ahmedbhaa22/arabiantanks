...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <a type="button" href="<?= $this->url->get('orders/index/') . $Module_ID ?>" data-toggle="modal"
               class="btn btn-edit-my-data green-jungle btn-outline   btn-block">
                <?php echo $translate->_("Reset Filter"); ?>
            </a>
        </div>
    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            <div class="row col-sm-2"><button type="submit" id="filter-toggle-btn" class="btn btn-default col-sm-12"><?php echo $translate->_("Filter"); ?></button></div>
            <div class="clear"></div>
