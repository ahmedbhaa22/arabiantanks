...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            <div class="row col-sm-2"><button id="filter-toggle-btn" value="Apply Filter" class="btn btn-default col-sm-12"><?php echo $translate->_("Filter"); ?></button></div>
            <div class="clear"></div>
            <div class="row col-sm-12" id="filter-toggle">
                <form method="POST" action="<?= $this->url->get('orders/filter/') . $Module_ID ?>" enctype="multipart/form-data">
                ...
                <table
                    ...
                    <?php foreach ($page->items as $content): ?>
                        <tr class="gradeX">
                            ...
                            <td><a href="<?= $this->url->get('orders/ordersuser/') . $Module_ID ?>?id=<?php echo $content->User_ID ?>"><?php echo $content->UsersMobile->Title ?></a></td>
                            ...
                            <td>
                                <div class="btn-group" style="position:relative">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="<?= $this->url->get('orders/vieworder') ?>/<?php echo $content->ID ?>"
                                               data-toggle="modal">
                ...
                <div class="col-md-7 col-sm-7">
                    <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                        <ul class="pagination" style="visibility: visible;">
                            <li><?php echo $this->tag->linkTo("orders/index/{$Module_ID}", "First") ?></li>
                            <li><?php echo $this->tag->linkTo("orders/index/{$Module_ID}?page=" . $page->before, "Previous") ?></li>
                            <li><?php echo $this->tag->linkTo("orders/index/{$Module_ID}?page=" . $page->next, "Next") ?></li>
                            <li><?php echo $this->tag->linkTo("orders/index/{$Module_ID}?page=" . $page->last, "Last") ?></li>
                        </ul>
                    </div>
                </div>
            </div>
