      ...
      <div class="col-lg-12">
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
		      ...
		      <a type="button" href="{{url('clients/view/'~visit.client.ID)}}" class="btn btn-xs btn-info">
                    <i class="fa fa-user" aria-hidden="true"></i>مشاهدة بروفايل العميل
                  </a>
                  <a type="button" href="{{url('sales_visits/edit/'~visit.id)}}"  class="btn btn-sm btn-success pull-right">
