<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            <a type="button" href="<?= $this->url->get() ?>" data-toggle="modal" class="btn green-jungle btn-outline">
                <?= $translate->_('Back') ?>
            </a>
        </div>

        <div class="actions">
            <a type="button" href="<?= $this->url->get('application_settings/deleteApplication') ?>" class="btn green-jungle btn-outline"  onclick="return confirm('Are you sure ?')">
