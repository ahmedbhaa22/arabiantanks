            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a class="imgandtext" href="{{url('menus/main')}}">
                    ...
                    <!---slide---->
                    <div class="swiper-slide">
                        <a class="imgandtext" href="{{url('users_application_module')}}">
                            <div class="img-section-container">
                    ...
                    <!---slide---->
                    <!-- <div class="swiper-slide">
                        <a class="imgandtext" href="{{url('application_localization')}}">
                            <div class="img-section-container">
                    ...
                    <!---slide---->
                    <div class="swiper-slide">
                        <a class="imgandtext" href="{{url('application_settings')}}">
                            <div class="img-section-container">
                    ...
                    <!---slide---->
                    <div class="swiper-slide">
                        <a class="imgandtext" href="{{url('application_api')}}">
                            <div class="img-section-container">
                                <div class="img-section" style="background: url('{{this.url_shared.get()}}img/sections/directions.png') center center no-repeat ; background-size: cover; "></div>
                            </div>
                            <h4>{{translate._("Application API Creator")}}</h4>
                        </a>
