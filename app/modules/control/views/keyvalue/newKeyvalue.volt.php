    ...
    <form action="<?= $this->url->get('keyvalue/createKeyvalue') ?>" class="form-horizontal" autocomplete="off" method="post">
        <div class="modal-body" >
            <div class="portlet-body " style=" padding: 15px;">
                <div class="row">
                    ...
                    <div class="col-sm-12" id="main-depts<?= $group->ID ?>" style="">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12" id="select-options<?= $group->ID ?>" style="display: none;">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12" id="kv_validation_settings" style="">
                        <div class="form-group">
                            <label for="fieldTitle" class="control-label col-xs-12 no-padding">الفاليديشن </label>
                            <?php foreach ($kv_types as $kv_type) { ?>
                            <div class="col-xs-3 nopadding-r">
