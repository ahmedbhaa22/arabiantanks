            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    ...
                    <ul class="dropdown-menu dropdown-menu-default">
                        {%if(this.router.getModuleName()=='cms')%}
                        <li>
                        ...
                        {%endif%}
                        {%if(this.router.getModuleName()=='control')%}
                        <li>
    ...
    <div class="page-sidebar-wrapper">
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-closed " data-keep-expanded="false"
                ...
                <li class="   ">
                    <a href="{{url('menus/main')}}" class="nav-link ">
                ...
                <li class=" ">
                    <a href="{{url('users_application_module')}}" class="nav-link ">
                ...
                <!-- <li class=" ">
                    <a href="{{url('application_localization')}}" class="nav-link ">
                ...
                <li class=" ">
                    <a href="{{url('application_settings')}}" class="nav-link ">
