...
<!--                        <th class="sorting"><?= $translate->_('Item') ?></th>-->
                    ...
                    <?php foreach ($page->items as $content): ?>
                        <tr class="gradeX">
                            ...
                            <td><a href="<?= $this->url->get('log/user/') ?><?php echo $content->user_id ?>"><?php echo $content->Users->User ?></a></td>
                            <td><a href="<?= $this->url->get('content/main/') ?><?php echo $content->module_id ?>"><?php echo $content->Module->Title ?></a></td>
                            <td><a href="<?= $this->url->get() ?><?php echo $content->link ?><?php echo $content->item_id?>"><?= $translate->_('View Content') ?></a></td>
