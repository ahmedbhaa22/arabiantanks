...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions">
            ...
            <a type="button" href="{{url('main_departments/index/') ~ Module_ID}} " data-toggle="modal" class="btn green-jungle btn-outline">
                {{translate._("Back")}}
            </a>
        </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                ...
                <select id="dynamic_select">
                    <option value="{{url('main_departments/edit/' ~ID)}}">{{translate._("Default")}}</option>
                    {%for lang in langs%}
                    <option value="{{url('main_departments/edit/' ~ID)}}?lang_id={{lang.lang_id}}">{{lang.LangDetails.title}}</option>
                    {%endfor%}
                </select>
            </div>
