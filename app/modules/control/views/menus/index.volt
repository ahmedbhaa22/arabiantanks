...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions btn-group btn-group-lg btn-group-solid margin-bottom-10 ">
            <a type="button" href="{{url('menus/new/') ~menu_cms_id}}" data-toggle="modal" class="btn btn-edit-my-data dark" data-target=".new-menu">
                        ...
                        <div class="swiper-slide small">
                            ...
                            <div class="  button-over-block-2">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="{{url('menus/edit/') ~item.id}}" data-toggle="modal" data-target=".edit-menu"> تعديل</a>
                                    </li>
                                    <li>
                                        <a class="" href="{{url('menus/delete/') ~item.id}}" onclick="return confirmDelete()" > حذف العنصر </a>
                                    </li>
