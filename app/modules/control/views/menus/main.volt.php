...
<div class="portlet light bordered">
    <div class="portlet-title">
        ...
        <div class="actions btn-group btn-group-lg btn-group-solid margin-bottom-10 ">
            <a type="button" href="<?= $this->url->get('menus/newMenu') ?>" data-toggle="modal" class="btn btn-edit-my-data dark" data-target=".newMenu">
                أضافة منيو
            </a>
        </div>
    </div>
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide small">
                            <a class="imgandtext" href="<?= $this->url->get('menus/index/') . $item->id ?>">
                            ...
                            <div class="  button-over-block-2">
                                ...
                                <ul class="dropdown-menu" role="menu">
                                    <li>
                                        <a href="<?= $this->url->get('menus/editMenu/') . $item->id ?>" data-toggle="modal" data-target=".editMenu"> تعديل</a>
                                    </li>
                                    <li>
                                        <a class="" href="<?= $this->url->get('menus/deleteMenu/') . $item->id ?>" onclick="return confirmDelete()" > حذف العنصر </a>
                                    </li>
...
<!-- Modal New Menu Item -->
<div class="newMenu modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
...
<div class="editMenu modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog ">
        <div class="modal-content">
