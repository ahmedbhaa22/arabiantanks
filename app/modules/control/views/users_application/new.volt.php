    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            ...
            <div class="form-group">
                <label for="fieldTitle" class="col-sm-2 control-label">Application Title</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <?php echo $this->tag->selectStatic(["Active", array("1" => "Yes", "0" => "No"), "class" => "form-control", "id" => "fieldToggleGrid"]) ?>

                </div>
            </div>

            <div class="form-group">
                <label for="fieldTitle" class="col-sm-2 control-label">UserName</label>
                <div class="col-sm-10">
                    <?php echo $this->tag->textField(["User", "size" => 30, "class" => "form-control", "id" => "fieldTitle","required"=>"required"]) ?>
                </div>
            </div>
            <div class="form-group">
                <label for="fieldTitle" class="col-sm-2 control-label">Password</label>
                <div class="col-sm-10">
                    <?php echo $this->tag->textField(["Pass", "size" => 30, "class" => "form-control", "id" => "fieldTitle","required"=>"required"]) ?>
                </div>
            </div>
            <div class="form-group">
                <label for="fieldTitle" class="col-sm-2 control-label">Full Name</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="fieldTitle" class="col-sm-2 control-label">Default Language</label>
                <div class="col-sm-10">
                    <?php
