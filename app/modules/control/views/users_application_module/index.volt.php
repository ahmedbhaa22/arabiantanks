...
<div class="clearfix"></div>
    <div class="portlet-body">
        <div id="sample_1_wrapper">
                    ...
                    <div class="swiper-container swiper-container-horizontal swiper-container-rtl">
                        <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                            ...
                            <div class="swiper-slide swiper-slide" style="width: 227.8px; margin-left: 10px;">
                                <a class="imgandtext" href="<?= $this->url->get('users_application_module/moduleHome/' . $module->ID) ?>">
                                ...
                                <div class="button-over-block-2">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        ...
                                        <li>
                                            <a href="<?= $this->url->get('users_application_module/delete/') . $module->ID ?>"  onclick="return confirm('Are you sure you want to delete this Module?');"><?= $translate->_('Delete') ?></a>
                                        </li>
            ...
            <div class="col-xs-12">
                <a href="<?= $this->url->get('users_application_module/new/') ?>" data-toggle="modal" style="display:inline-block;" class="btn  green-jungle btn-sm gap">
