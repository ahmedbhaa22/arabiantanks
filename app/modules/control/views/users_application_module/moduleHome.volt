        ...
        <div class="swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <a class="imgandtext" href="{{url('main_departments/index/' ~Module_ID)}}">
                ...
                <!---slide---->
                <div class="swiper-slide">
                    <a class="imgandtext" href="{{url('users_application_module/settings/' ~Module_ID)}}">
                        <div class="img-section-container">
                ...
                <!---slide---->
                <div class="swiper-slide">
                    <a class="imgandtext" href="{{url('keyvalue/index/' ~Module_ID)}}">
                        <div class="img-section-container">
                ...
                <!---slide---->
                <div class="swiper-slide">
                    <a class="imgandtext" href="{{url('users_application_module/strings/' ~Module_ID)}}">
                        <div class="img-section-container">
...
<div class="clearfix"></div>
<div class="col-xs-12">
                <a href="{{url('users_application_module/edit/') ~Module_ID}}" data-toggle="modal" style="display:inline-block;" class="btn  green-jungle btn-sm gap">
