...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        ...
        <div class="gap">
            <form action="<?= $this->url->get('users_application_module/stringCreate') ?>" method="post">
                      ...
                      <td>
                          <div class="btn-group">
                              ...
                              <ul class="dropdown-menu" role="menu">
                                  <li>
                                      <a href="<?= $this->url->get('users_application_module/stringEdit/' . $Module_ID) ?>&word=<?= urlencode($string->word_key) ?>" data-toggle="modal" data-target="#editWord<?= $string->id ?>">
                                          <i class="icon-note"></i> <?= $translate->_('Edit') ?> </a>
                                  </li>
                                  <li>
                                      <a href="<?= $this->url->get('users_application_module/stringDelete/' . $Module_ID) ?>&word_key=<?= urlencode($string->word_key) ?>" class="">
