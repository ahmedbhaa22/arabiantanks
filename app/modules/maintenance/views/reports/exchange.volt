...
<div class="clearfix"></div>
{{ partial("reports/partials/partial_menu") }}<!--end mt-element-step -->
...
<div class="portlet light gap clearfix">
    ...
    <div class="portlet-body">
            ...
            <div class="panel panel-info">
                ...
                <div id="collapse-clients-filter" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form role="form" id="exchange_reports_filter">
                            <div class="row">
                                <div class="col-sm-4">
        ...
        <div class="printable-area" id="exchange_req_report">
...
<script>
    ...
    var exchange_url="{{url('maintenance_module/reports/exchange_table')}}";
    $("#exchange_req_report").load(exchange_url);
