...
<div class="portlet light gap clearfix">
    ...
    <div class="portlet-body">
            ...
            <div class="panel panel-info">
                ...
                <div id="collapse-clients-filter" class="panel-collapse collapse">
                    <div class="panel-body">
                        <form role="form" id="requests_reports_filter">
                            <div class="row">
                                <div class="col-sm-4">
        ...
        <div class="printable-area" id="requests_req_report">
...
<script>
    ...
    var requests_url="{{url('maintenance_module/reports/requests_table')}}";
    $("#requests_req_report").load(requests_url);
