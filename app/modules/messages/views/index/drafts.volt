                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column"  id="sample_1">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{url("index/compose?draft=" ~ draft.ID)}}" class="btn btn-xs btn-info"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> </a>
...
function deleteMessage(id) {
    if(confirm("Are you sure you want to delete this message?")){
        window.location = "{{url('index/delete_draft')}}" + "/" + id;
    }
}
</script>