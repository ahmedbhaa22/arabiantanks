    ...
    <div class=" ">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-12 col-xs-12 hidden-xs">
                <div class="" style="width: 100%; min-height: 180px; overflow: hidden ; background: url({{url.getStatic('img/notification.png')}}) center center no-repeat ; background-size: contain"></div>
            </div>
        </div>
    </div>
</div>
...
<div class="portlet light">
    ...
    <div class="portlet-body">
        <form role="form" action="{{url('index/store')}}" id="send_notification" method="post">
        <div class="one-log">
            <div class="form-group clearfix">
                ...
                {% if settings.enable_schedueling %}
                <div class="log-profile text-primary col-sm-3 col-xs-12">
                    <label>
            ...
            <div class="divider col-xs-12 gap ">
                ...
                <div class="form-group funkyradio">
                    ...
                    {% if settings.hasPermission(type) %}
            ...
            <div class="col-sm-6 col-sm-offset-3 text-center">
               <!-------- pie char -->
                {% if settings.enable_statistics == 1 %}
...
$("select[name='module_id']").change(function(){
    ...
    if($("select[name='module_id']").val()){
        $.ajax({
            url: "{{url('index/fetch_topics?module_id=')}}" + $("select[name='module_id']").val(),
            method: "GET",
