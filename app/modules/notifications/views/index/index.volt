        ...
        <div class=" ">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-12 col-xs-12 hidden-xs">
                    ...
                    {% else %}
                    <div class=""
                         style="width: 100%; min-height: 180px; overflow: hidden ; background: url({{url.getStatic('img/notification.png')}}) center center no-repeat ; background-size: contain"></div>
                    {% endif %}
                </div>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions btn-group btn-group-lg btn-group-solid margin-bottom-10 ">
                    ...
                    <a type="button" href="{{url('index/create')}}" class="btn btn-edit-my-data dark  ">
                        {{ translate._("New Notification") }}
                    </a>
                    <a type="button" href="{{url('settings')}}" class="btn btn-edit-my-data dark  ">
