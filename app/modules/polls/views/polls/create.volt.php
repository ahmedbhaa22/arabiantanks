...
<div class="portlet light bordered">
    ...
    <div class="portlet-body">
        ...
        <div class="row">
            <form method="post" action="<?= $this->url->get('polls/store') ?>" enctype="multipart/form-data">
                <div class="col-xs-12 no-padding">

                    <div class="col-xs-10">
                        <input type="text" class="form-control bg-info" name="name" placeholder="عنوان الاستعلام" required>
                    </div>
