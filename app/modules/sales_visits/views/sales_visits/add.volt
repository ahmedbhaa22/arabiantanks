...
<div class="page-bar " style="position: relative">
 <ul class="page-breadcrumb">
		...
		<li>
			<a href="{{this.url_shared.get('sales_visits_module/sales_visits/index')}}"><span>الزيارات</span></a>
            <i class="fa fa-angle-left"></i>
		</li>
		<li>
			<span>اضافة الزيارة</span>
		</li>
    </ul>
</div>
...
<div class="portlet-title">
    ...
    <form role="form" action="{{this.url_shared.get('sales_visits_module/sales_visits/save')}}" method="post" enctype="multipart/form-data">
...
<script type="text/javascript">
    $('#filter_clients').on('click', function()
    {
       $.ajax({
        type: 'get',
        url: "{{this.url_shared.get('sales_visits_module/sales_visits/filterClients')}}",
        data:{
