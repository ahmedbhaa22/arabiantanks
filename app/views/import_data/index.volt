    ...
    <div class="portlet-body">
        <div id="sample_1_wrapper">
            <div class="row col-sm-12" id="filter-toggle">
                <form method="POST" action="{{ url('import_data/create/') }}" enctype="multipart/form-data">
                                ...
                                <td>
                                    <div class="btn-group" style="position:relative">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li>
                                                <a href="{{url('import_data/edit/' ~content.ID)}}" data-toggle="">
                                                    <i class="icon-tag"></i> {{ translate._("Edit") }}</a>
                                            </li>
                                            <li>
                                                <a href="{{url('import_data/delete/' ~content.ID)}}" data-toggle="">
