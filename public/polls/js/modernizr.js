/*!
 * modernizr v3.3.1
 * Build https://modernizr.com/download?-animation-batteryapi-beacon-classlist-dataset-dataview-fetch-filereader-filesystem-forcetouch-fullscreen-gamepads-geolocation-history-inlinesvg-intl-pagevisibility-performance-pointerevents-pointerlock-proximity-quotamanagement-serviceworker-smil-speechrecognition-speechsynthesis-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-texttrackapi_track-touchevents-userdata-vibrate-webaudio-addtest-atrule-domprefixes-hasevent-mq-prefixed-prefixedcss-prefixedcssvalue-prefixes-printshiv-setclasses-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
