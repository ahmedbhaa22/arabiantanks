...
var Login = function () {
    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch(["img/login-img/bg1.jpg", "img/login-img/bg2.jpg", "img/login-img/bg3.jpg" , "img/login-img/bg4.jpg", "img/login-img/bg5.jpg" , "img/login-img/bg6.jpg" , "img/login-img/bg7.jpg" ], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
